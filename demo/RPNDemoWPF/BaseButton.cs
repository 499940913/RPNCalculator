...
namespace RPNDemoWPF
{
    ...
    public class BaseButton : Button
    {
        static BaseButton()
        {
         ...
         public static readonly DependencyProperty IsOperatorProperty = DependencyProperty.Register(
            "IsOperator", typeof(bool), typeof(BaseButton), new PropertyMetadata(default(bool)));
